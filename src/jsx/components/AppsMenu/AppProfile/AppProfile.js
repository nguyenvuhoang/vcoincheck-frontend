...
import project8 from "../../../../images/project/15.png";
							...
							<div className="profile-info">
								...
								<div className="profile-details">
									...
									<div className="profile-email px-2 pt-2">
										<h4 className="text-muted mb-0">admin01</h4>
										<p>Username</p>
									</div>
									...
									<div className="profile-statistics">
										<div className="text-center">
											<div className="row">
												...
												<div className="col">
													<h3 className="m-b-0">45</h3> <span>Point</span>
												</div>
											</div>
								...
								<div className="custom-tab-1">
									<ul className="nav nav-tabs">
										<li className="nav-item" onClick={() => setActiveToggle("posts")}>
											<Link to="#my-posts" data-toggle="tab" className={`nav-link ${activeToggle === "posts" ? "active show" : ""}`}>Your project</Link>
										</li>
										...
										<div id="my-posts" className={`tab-pane fade ${activeToggle === "posts" ? "active show" : ""}`} >
											<div className="my-post-content pt-3">
												...
												<div className="profile-uoloaded-post border-bottom-1 pb-5">
													<img src={project8} alt="" className="img-fluid w-100" />
													<Link className="post-title" to="/post-details">
														<h3 className="text-black">An Ethereum-compatible smart contracts on a Polkadot parachain</h3>
													</Link>
													<p>
													...
													<button className="btn btn-primary mr-2">
														<span className="mr-2"> <i className="fa fa-dollar-sign" /> </span>110
													</button>
													<button className="btn btn-secondary" onClick={() => setReplayModal(true)}>
														<span className="mr-2"> <i className="fa fa-buysellads" /></span>120
													</button>
												</div>
